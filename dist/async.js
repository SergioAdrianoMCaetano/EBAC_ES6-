...
//PROMISE
var funcaoMuitoPesadaComPromise = new Promise(function (resolve, rejeita) {
  try {
    var execucao = 0;
    for (var i = 0; i < 1000000000; i++) {
      execucaso++;
...
var promiseComParametro = function promiseComParametro(login, senha) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          promiseComParametro('sergioadrianomc@gmail.com', 123456).then(function (resultado) {
            console.log(resultado);
          });
          _context.prev = 2;
          _context.next = 5;
          return funcaoMuitoPesadaComPromise;
        case 5:
