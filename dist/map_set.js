...
var array = ['Sérgio Adriano', 'Mario Bittencur', 'Gerson Koringa', 'Mario Lobo Zagallo', 'Mario Bittencur', 'Gerson Koringa'];
var arrayComSet = new Set([].concat(array));
var arraySemDuplicatas = _toConsumableArray(arrayComSet);
console.log(array);
